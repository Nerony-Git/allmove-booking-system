! function (e, t) {
          ...
          return r && !r[x] && (r = Ee(r)), i && !i[x] && (i = Ee(i, o)), ce(function (o, s, a, l) {
             ...
             if (o) {
                if (i || e) {
                   ...
                   for (u = v.length; u--;)(f = v[u]) && -1 < (c = i ? O(o, f) : p[u]) && (o[c] = !(s[c] = f))
                }
       ...
       n ? (G.set(e, t, !1), w.event.add(e, t, {
          ...
          handler: function (e) {
             ...
             if (1 & e.isTrigger && this[t]) {
                ...
                else if (s = o.call(arguments), G.set(this, t, s), r = n(this, t), this[t](), s !== (i = G.get(this, t)) || r ? G.set(this, t, !1) : i = {}, s !== i) return e.stopImmediatePropagation(), e.preventDefault(), i.value
       ...
       add: function (e, t, n, r, i) {
          ...
          if (m)
             for (n.handler && (n = (o = n).handler, i = o.selector), i && w.find.matchesSelector(ie, i), n.guid || (n.guid = w.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (t) {
                ...
                }), c = (t = (t || "").match(P) || [""]).length; c--;) d = g = (a = Ce.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), d && (f = w.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = w.event.special[d] || {}, u = w.extend({
                type: d,
                origType: g,
                data: r,
                handler: n,
    ...
    function qe(e, t, n, r) {
       ...
       if (p && (o = (i = we(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
          for (l = (a = w.map(me(i, "script"), Oe)).length; f < p; f++) c = i, f !== d && (c = w.clone(c, !0, !0), l && w.merge(a, me(c, "script"))), n.call(e[f], c, f);
          if (l)
             for (u = a[a.length - 1].ownerDocument, w.map(a, Pe), f = 0; f < l; f++) c = a[f], he.test(c.type || "") && !G.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
          ...
          computeStyle: {
             ...
             fn: function (e, t) {
                ...
                var a, l, c = void 0 === o ? t.gpuAcceleration : o,
                   ...
                   v = N("transform");
                if (l = "bottom" == h ? "HTML" === u.nodeName ? -u.clientHeight + d.bottom : -f.height + d.bottom : d.top, a = "right" == m ? "HTML" === u.nodeName ? -u.clientWidth + d.right : -f.width + d.right : d.left, c && v) p[v] = "translate3d(" + a + "px, " + l + "px, 0)", p[h] = 0, p[m] = 0, p.willChange = "transform";
                else {
                   var y = "bottom" == h ? -1 : 1,
                      b = "right" == m ? -1 : 1;
